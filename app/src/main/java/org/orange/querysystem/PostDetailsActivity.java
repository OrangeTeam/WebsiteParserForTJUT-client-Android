...
public class PostDetailsActivity extends FragmentActivity {
    ...
    public static final String EXTRA_POST_ID = PostDetailsActivity.class.getName()
            + "EXTRA_POST_ID";
    ...
    public void loadPost(Post post) {
        ...
        mainBodyView
                .loadDataWithBaseURL(post.getUrl(), post.getMainBody(), "text/html", null, null);
    ...
    private class LoadPost extends AsyncTask<Long, Void, Post> {
        ...
        protected Post doInBackground(Long... id) {
            ...
            try {
                database.open();
                post = database.getPostsFromDB(Contract.Posts._ID + " = " + id[0], null, null)
                        .get(0);
