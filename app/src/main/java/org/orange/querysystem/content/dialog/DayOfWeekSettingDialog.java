...
public class DayOfWeekSettingDialog extends DialogFragment{
	...
	public static final String DAY_OF_WEEK_KEY = DayOfWeekSettingDialog.class.getName() + "day_of_week_key";
	...
	public void applyArguments(){
		try {
			...
			throw new IllegalArgumentException("非法参数"+getArguments().getInt(DAY_OF_WEEK_KEY, 0), e);
		}
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		applyArguments();
		System.arraycopy(getResources().getStringArray(R.array.days_of_week), 1, MULTI_CHOICE_ITEMS, 0, 7);
	}
	@Override
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		return new AlertDialog.Builder(getActivity())
			...
			.setMultiChoiceItems(MULTI_CHOICE_ITEMS, checkedItems, new OnMultiChoiceClickListener() {
				@Override
