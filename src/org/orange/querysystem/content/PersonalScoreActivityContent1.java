...
public class PersonalScoreActivityContent1 extends ListActivity implements ParseWebPage.CoursesInfo{
		...
		findViewById(R.id.sample_button).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						SlideoutActivity.prepare(PersonalScoreActivityContent1.this, R.id.inner_content, width);
						startActivity(new Intent(PersonalScoreActivityContent1.this,
								MenuActivity.class));
    ...
    class SpinnerOnSelectedListener implements OnItemSelectedListener{
    	...
    	public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id){
    		...
    		if(adapterView.getItemIdAtPosition(position) == 1){
    			startActivity(new Intent(PersonalScoreActivityContent1.this, TerminalScoreActivity.class));
    		}
...
//		if(semester.equals("1")){
			while(!(courses.get(j).isFirstSemester() && (courses.get(j).getYear() == Integer.parseInt("2010")))){
				j++;
			}
	        for(int i=j,k=0; i<courses.size() && courses.get(i).isFirstSemester() && (courses.get(i).getYear() == Integer.parseInt("2010")); i++){
...
//		listView.setSelector(drawable);
    ...
    public boolean onMenuItemSelected(int featureId, MenuItem item) {
    	...
    	if(item.getItemId()==2){
    		startActivity(new Intent(PersonalScoreActivityContent1.this, LoginActivity.class));
    	}
