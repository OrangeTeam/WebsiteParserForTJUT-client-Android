		...
		findViewById(R.id.sample_button).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						SlideoutActivity.prepare(PersonalScoreActivityContent2.this, R.id.inner_content, width);
						startActivity(new Intent(PersonalScoreActivityContent2.this,
								MenuActivity.class));
    ...
    class SpinnerOnSelectedListener implements OnItemSelectedListener{
    	...
    	public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id){
    		...
    		if(adapterView.getItemIdAtPosition(position) == 1){
    			startActivity(new Intent(PersonalScoreActivityContent2.this, TerminalScoreActivity.class));
    		}
...
//		listView.setSelector(drawable);
    ...
    public boolean onMenuItemSelected(int featureId, MenuItem item) {
    	...
    	if(item.getItemId()==2){
    		startActivity(new Intent(PersonalScoreActivityContent2.this, LoginActivity.class));
    	}
