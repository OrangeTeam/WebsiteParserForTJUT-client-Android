	...
	private class UpdateCoursesListToDatabase extends AsyncTask<String, Void, Boolean> {
		...
		protected Boolean doInBackground(String... args){
			...
			try {
				...
				int currentYear = SettingsActivity.getCurrentAcademicYear(RefreshScoresFragmentActivity.this);
				byte currentSemester = SettingsActivity.getCurrentSemester(RefreshScoresFragmentActivity.this);
		...
		private String getStartAcademicYear(SQLiteDatabase database, SchoolWebpageParser parser) throws NumberFormatException {
			String result  = getStartAcademicYear(database);
			if(result != null)
				return result;
			// 尝试刷新个人信息
			PersonalInformationUpdater updater = new PersonalInformationUpdater(RefreshScoresFragmentActivity.this, parser);
