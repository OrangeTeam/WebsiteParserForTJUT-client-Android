...
public class TimeAndAddressSettingDialog extends DialogFragment implements
	 ...
	 * @return 此类的新实例
	 */
	public static TimeAndAddressSettingDialog newInstance(TimeAndAddress aTimeAndAddress, String tag){
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		//构建并设置对话框
		View dialogContent = getActivity().getLayoutInflater().inflate(R.layout.time_and_adress_entry, null);
		...
		builder.setView(dialogContent)
			...
			.setNegativeButton(android.R.string.cancel, new OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					applyArgument();
					mListener.onDialogNegativeClick(TimeAndAddressSettingDialog.this, getArguments().getString(TAG_KEY));
				}
			});
	...
	private void showDialog(int id){
		...
		switch(id){
			...
			case DIALOG_PERIOD:
				...
				break;
			default:throw new IllegalArgumentException("非法参数："+id);
		}
	 ...
	 * Each method passes the {@link TimeAndAddressSettingDialog} in case the host needs to query it.
	 */
